export default class BudgetTracker{
									...
									<tbody>
													<tr>
																	<td colspan="5" class="controls">
																					<button type="button" class="new-entry">
																						New			
																					</button>
																	</td>
													</tr>
				...
				static entryHtml(){
							return`
												<tr >
																...
																<td>
																					<input class="input input-desctiption" type="text" placeholder="Add income/expense" >
																	</td>
																<td>
				...
				update Summary(){
						const total = this.getEntry	Rows().reduce((total, row )=>{
...
amount:parseFloat(row.querySelector(".input-amount").value),
				...
				addEntry(entry = {}){
		this.root.querySelector(".entries").insertAdjacentHTML("beforeend", BudjetTracker.entryHTML() );
